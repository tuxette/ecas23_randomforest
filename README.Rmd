...
- [Posit cloud](https://posit.cloud/) for which you **need** to create a **Posit account**

- [Google Colab](https://colab.research.google.com/) for which you **need** a **Google account**

You may still have to install the different packages/libraries once you're logged in (depending of the type of document/project shared by the speakers).